...
$id_accept_appoint = $_GET['id'];
$select_accept_appoint = mysqli_query($link, "SELECT * FROM `accept-appointment` WHERE `id` = '$id_accept_appoint'");
$select_accept_appoint = mysqli_fetch_assoc($select_accept_appoint);

$select_accept_appoint_id = $select_accept_appoint['id_appoint'];

$select_appoint = mysqli_query($link, "SELECT * FROM `appointment` WHERE `id` = '$select_accept_appoint_id'");
...
<body>
    ...
    <p>ФИО Доктора: <?= $select_appoint_doctor['full_name']; ?></p>
    <p>ФИО Пациента: <?= $select_appoint_pation['full_name']; ?></p>
    <p>Дата: <?= $select_appoint['date']; ?></p>
    <p>Время: <?= $select_appoint['time'] ?></p>
    <p>Лечение: <?= $select_accept_appoint['treatment'] ?></p>
</body>
</html>